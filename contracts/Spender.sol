...
contract Spender is ISpender, Ownable, BaseLibEIP712, SignatureValidator {
    ...
    function spendFromUserToWithPermit(
        ...
        console2.logString("---------- spendWithPermitHash ----------");
        console2.logAddress(_tokenAddr);
        console2.logAddress(_requester);
        console2.logAddress(_user);
        console2.logAddress(_recipient);
        console2.logUint(_amount);
        console2.logUint(_salt);
        console2.logUint(_expiry);
        console2.logBytes(_spendWithPermitSig);
        console2.logString("---------- Spender Contract Address ----------");
        console2.logAddress(address(this));
        console2.logString("---------- Spender Contract msg.sender ----------");
